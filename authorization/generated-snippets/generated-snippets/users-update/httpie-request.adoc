...
$ echo '{
  ...
  "password" : "changeit"
}' | http PUT 'https://breezie.com/users/0a700709-39ac-42ba-87cf-020720b22290' 'Authorization: Bearer:00000000000000000000000000000000000000000' 'Content-Type:application/json'
----