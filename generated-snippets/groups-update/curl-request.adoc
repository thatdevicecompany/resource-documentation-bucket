[source,bash]
----
$ curl 'https://breezie.com/groups/6fe00a7d-c965-496d-95dc-062ee8184a00' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
