...
$ echo '{
  ...
  "personal" : false,
  "hideOnHub" : false
}' | http PUT 'https://breezie.com/groups/5595a520-9940-4cba-aa24-bc399958bb57' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----