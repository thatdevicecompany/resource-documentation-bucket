[source,bash]
----
$ curl 'https://api.breezie.com/devices/f6d2df17-d251-4100-a70e-16c420895c7f/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
