[source,bash]
----
$ curl 'https://api.breezie.com/devices/a7b2f043-53b7-49c5-ba93-77b29bafb5e9/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
