...
}' | http POST 'https://api.breezie.com/devices/e5cf47f0-30f0-4d09-bb82-bc74683d8cd9/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----