[source,bash]
----
$ curl 'https://api.breezie.com/groups/fa6614ce-56cd-4723-a73d-36c667a08788' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
