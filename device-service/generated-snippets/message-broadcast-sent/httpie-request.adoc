...
}' | http POST 'https://api.breezie.com/devices/28e75d26-6ae9-411f-b80a-2e31c80df8d5/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----