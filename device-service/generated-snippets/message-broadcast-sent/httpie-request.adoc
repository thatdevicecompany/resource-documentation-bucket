...
}' | http POST 'https://api.breezie.com/devices/09453e24-4252-4c2f-b564-fcc9bce4cd63/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----