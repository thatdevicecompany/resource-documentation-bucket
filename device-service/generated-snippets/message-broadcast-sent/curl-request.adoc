[source,bash]
----
$ curl 'https://api.breezie.com/devices/3efbde9e-8184-4f0e-8406-fc14ca6a6667/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
