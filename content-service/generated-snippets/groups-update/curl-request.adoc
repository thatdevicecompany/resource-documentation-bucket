[source,bash]
----
$ curl 'https://api.breezie.com/groups/55de10e3-280b-4e2a-910a-5b9685797d97' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
