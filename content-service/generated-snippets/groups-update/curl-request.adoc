[source,bash]
----
$ curl 'https://breezie.com/groups/5c265c34-7a63-49e9-afa6-4a93c31574d8' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
