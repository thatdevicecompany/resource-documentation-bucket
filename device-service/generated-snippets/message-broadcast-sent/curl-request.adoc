[source,bash]
----
$ curl 'https://api.breezie.com/devices/fb852cb4-4f10-4c7e-9ca9-2ca06119e4b4/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
