...
include::{user-snippets}/users-get-list-by-organization/http-response.adoc[]
...
include::{user-snippets}/users-get-list-by-region/http-response.adoc[]
...
include::{user-snippets}/users-get-list-by-campus/http-response.adoc[]
...
include::{user-snippets}/users-get-list-by-facility/http-response.adoc[]
