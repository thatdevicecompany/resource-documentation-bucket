[source,bash]
----
$ curl 'https://api.breezie.com/devices/9f197c11-ff5b-4312-a0b5-eaf2793b44cf/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
