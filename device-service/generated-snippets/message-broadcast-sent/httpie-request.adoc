...
}' | http POST 'https://api.breezie.com/devices/9f5fb41d-1632-467d-a4a6-d30eb12ff344/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----