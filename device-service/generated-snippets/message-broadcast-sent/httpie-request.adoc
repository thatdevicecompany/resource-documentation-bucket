...
}' | http POST 'https://api.breezie.com/devices/9e8875cc-f303-4bd0-b7cb-31f741635271/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----