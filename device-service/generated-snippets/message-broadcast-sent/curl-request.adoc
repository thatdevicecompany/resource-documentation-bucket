[source,bash]
----
$ curl 'https://api.breezie.com/devices/c4f8b5b9-e625-4472-865c-1beb1dfa2cb0/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
