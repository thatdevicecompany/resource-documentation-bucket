[source,bash]
----
$ curl 'https://api.breezie.com/groups/8a78a8b4-f9cf-425c-affb-9b72abc73109' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
