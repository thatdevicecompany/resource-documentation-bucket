[source,bash]
----
$ curl 'https://api.breezie.com/devices/b3833368-fb2d-45c6-aa55-5c1c1ef58766/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
