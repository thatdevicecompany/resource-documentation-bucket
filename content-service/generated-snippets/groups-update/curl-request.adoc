[source,bash]
----
$ curl 'https://api.breezie.com/groups/fde88ce7-4b55-453e-8121-2e8679245eae' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
