...
$ echo '{
  ...
  "personal" : false,
  "hideOnHub" : false
}' | http PUT 'https://api.breezie.com/groups/da6da21f-b17d-4392-bfb8-266a7190b986' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----