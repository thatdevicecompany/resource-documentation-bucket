[source,bash]
----
$ curl 'https://breezie.com/groups/cddbe37c-0f77-4b9d-8353-bc3f8cb37bf8' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
