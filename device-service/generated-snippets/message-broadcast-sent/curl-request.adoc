[source,bash]
----
$ curl 'https://api.breezie.com/devices/524baebd-887c-4494-b566-7125ca70fab1/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
