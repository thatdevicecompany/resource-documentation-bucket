...
}' | http POST 'https://api.breezie.com/devices/bea432cf-2510-4994-a0a0-34399de0e666/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----