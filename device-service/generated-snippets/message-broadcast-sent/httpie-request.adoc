...
}' | http POST 'https://api.breezie.com/devices/a90c78c5-293f-4c24-8fd7-5a2294640165/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----