[source,bash]
----
$ curl 'https://breezie.com/groups/a85f4b49-35d9-45fc-ba44-202e4fab61c6' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
  ...
  "createdTime" : 1482320503101,
  "createdBy" : "Bob Jones",
  "lastUpdatedTime" : 1482320504101,
