[source,bash]
----
$ curl 'https://api.breezie.com/devices/a74fa85e-ab3a-4058-9a1e-c3ab5eee667f/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
