...
}' | http POST 'https://api.breezie.com/devices/e2bee785-aa6a-4416-ac31-59d428122c6c/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----