[source,bash]
----
$ curl 'https://api.breezie.com/devices/ecd62bcb-571a-430b-a73c-cd2ffaad5261/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
