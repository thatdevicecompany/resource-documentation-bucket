[source,bash]
----
$ curl 'https://api.breezie.com/groups/3d0ccfcb-f8ca-45e3-862f-84621f006441' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
