[source,bash]
----
$ curl 'https://api.breezie.com/devices/28e75d26-6ae9-411f-b80a-2e31c80df8d5/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
