...
$ echo '{
  ...
  "hidden" : true,
  "personal" : false
}' | http PUT 'https://breezie.com/groups/cddbe37c-0f77-4b9d-8353-bc3f8cb37bf8' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----