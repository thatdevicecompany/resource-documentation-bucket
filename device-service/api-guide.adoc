...
*** <<resources-device-messages-all, Send synchronization message>>
...
|launch
|Opens the app specified in the `Payload`.
...
include::{device-snippets}/message-all-sent/request-fields.adoc[]

====== Example request (sync message)

include::{device-snippets}/message-all-sent/curl-request.adoc[]

====== Example response (sync message)

include::{device-snippets}/message-all-sent/http-response.adoc[]
...
====== Example response (launch app message)

include::{device-snippets}/message-launch-sent/http-response.adoc[]
