[source,bash]
----
$ curl 'https://breezie.com/groups/5595a520-9940-4cba-aa24-bc399958bb57' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
