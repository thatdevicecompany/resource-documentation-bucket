...
$ echo '{
  ...
  "hidden" : true,
  "personal" : false
}' | http PUT 'https://breezie.com/groups/8c5a0184-a2d7-4f28-9846-216ee7e68848' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----