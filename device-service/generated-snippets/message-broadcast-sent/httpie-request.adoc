...
}' | http POST 'https://api.breezie.com/devices/ff641bfb-ca78-4a6b-bd10-4624187074f6/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----