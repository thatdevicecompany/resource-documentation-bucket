...
}' | http POST 'https://api.breezie.com/devices/524baebd-887c-4494-b566-7125ca70fab1/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----