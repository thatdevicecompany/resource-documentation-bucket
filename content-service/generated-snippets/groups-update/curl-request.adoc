[source,bash]
----
$ curl 'https://breezie.com/groups/f4357ee7-3dc3-4a47-ac6b-c56b8f4614ff' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
