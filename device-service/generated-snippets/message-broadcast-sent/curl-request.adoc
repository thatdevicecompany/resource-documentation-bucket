[source,bash]
----
$ curl 'https://api.breezie.com/devices/e3f7e888-1ea2-48de-be12-b3683431d607/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
