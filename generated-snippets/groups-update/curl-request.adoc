[source,bash]
----
$ curl 'https://breezie.com/groups/20f27025-ec12-4d35-833f-3dbf556bc5a5' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
