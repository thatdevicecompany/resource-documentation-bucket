[source,bash]
----
$ curl 'https://api.breezie.com/devices/9a0f9208-e0bf-4cca-b66b-9c927b74ccf9/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
