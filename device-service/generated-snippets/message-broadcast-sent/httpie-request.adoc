...
}' | http POST 'https://api.breezie.com/devices/4a6b3f8c-c285-4435-a14a-d6d145fa7d1f/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----