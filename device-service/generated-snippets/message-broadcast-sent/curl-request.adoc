[source,bash]
----
$ curl 'https://api.breezie.com/devices/ee4d9799-2874-472c-834a-b9ef484e8630/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
