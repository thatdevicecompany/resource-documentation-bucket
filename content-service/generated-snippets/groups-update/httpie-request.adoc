...
$ echo '{
  ...
  "personal" : false,
  "hideOnHub" : false
}' | http PUT 'https://api.breezie.com/groups/903aacb5-7a72-4f39-b8eb-3ff8edaef847' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----