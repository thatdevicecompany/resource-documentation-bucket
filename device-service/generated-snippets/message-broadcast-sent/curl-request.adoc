[source,bash]
----
$ curl 'https://api.breezie.com/devices/95ce7aab-5c7b-4768-abae-dd8149da7a81/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
