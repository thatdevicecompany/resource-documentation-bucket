[source,bash]
----
$ curl 'https://api.breezie.com/devices/f21c82e7-f069-4837-9fe0-6bac6838a0c5/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
