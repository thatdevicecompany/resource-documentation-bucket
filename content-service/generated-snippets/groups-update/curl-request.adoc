[source,bash]
----
$ curl 'https://breezie.com/groups/ad516f9c-690e-4204-a87f-d0b40b46d3ee' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
  ...
  "createdTime" : 1475231847978,
  "createdBy" : "Bob Jones",
  "lastUpdatedTime" : 1475231848978,
