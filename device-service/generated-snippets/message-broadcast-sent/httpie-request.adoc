...
}' | http POST 'https://api.breezie.com/devices/ecd9e322-6c46-4b46-afa9-ec1a6cd09f4e/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----