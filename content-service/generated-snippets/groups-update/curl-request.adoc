[source,bash]
----
$ curl 'https://api.breezie.com/groups/d3e68b5f-d51e-4637-b228-294acb0275e1' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
