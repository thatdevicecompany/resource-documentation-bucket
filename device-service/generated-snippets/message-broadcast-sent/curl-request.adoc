[source,bash]
----
$ curl 'https://api.breezie.com/devices/c10da94f-d166-4ef8-9e3c-c7002eee4881/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
