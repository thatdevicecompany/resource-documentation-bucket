...
}' | http POST 'https://api.breezie.com/devices/7e452048-c9e3-4907-a66c-4820e549bb6f/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----