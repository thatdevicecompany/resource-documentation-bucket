[source,bash]
----
$ curl 'https://api.breezie.com/devices/ff641bfb-ca78-4a6b-bd10-4624187074f6/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
