...
}' | http POST 'https://api.breezie.com/devices/7c410fcb-2ab2-4a6d-960c-9206cc98014e/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----