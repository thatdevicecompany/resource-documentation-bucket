[source,bash]
----
$ curl 'https://breezie.com/groups/d7886dd0-d25a-4f18-bee5-931e1da55bbb' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
