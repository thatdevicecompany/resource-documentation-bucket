...
}' | http POST 'https://api.breezie.com/devices/e51193ba-e523-40f8-b9be-600237f23fe7/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----