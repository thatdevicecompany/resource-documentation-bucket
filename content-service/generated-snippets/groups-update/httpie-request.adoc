...
$ echo '{
  ...
  "visible" : true,
  "default" : true
}' | http PUT 'https://breezie.com/groups/ba2ac7e1-1cab-4f8c-9874-5c0a3c0127bc' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----