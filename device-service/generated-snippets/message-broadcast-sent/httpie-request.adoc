...
}' | http POST 'https://api.breezie.com/devices/0fc5688a-1311-45ab-8525-a9b3b489e6ab/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----