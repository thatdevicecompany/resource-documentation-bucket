[source,bash]
----
$ curl 'https://breezie.com/groups/495ddb20-4980-463d-8a8d-a823a5fd1a6e' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
