...
}' | http POST 'https://api.breezie.com/devices/631bee0b-a506-4d5c-ae70-b1ac1a00bc20/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----