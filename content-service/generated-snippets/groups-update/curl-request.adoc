[source,bash]
----
$ curl 'https://breezie.com/groups/ba2ac7e1-1cab-4f8c-9874-5c0a3c0127bc' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
  ...
  "createdTime" : 1477497463817,
  "createdBy" : "Bob Jones",
  "lastUpdatedTime" : 1477497464817,
