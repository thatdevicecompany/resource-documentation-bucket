[source,bash]
----
$ curl 'https://breezie.com/groups/182f9c36-0cab-470c-995d-37624e1a1efa' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
  ...
  "createdTime" : 1476446893974,
  "createdBy" : "Bob Jones",
  "lastUpdatedTime" : 1476446894974,
