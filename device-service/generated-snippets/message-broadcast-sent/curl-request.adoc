[source,bash]
----
$ curl 'https://api.breezie.com/devices/aaf0edbd-5909-4613-a5b1-a6af42711f96/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
