...
}' | http POST 'https://api.breezie.com/devices/95ce7aab-5c7b-4768-abae-dd8149da7a81/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----