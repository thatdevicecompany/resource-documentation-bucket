[source,bash]
----
$ curl 'https://breezie.com/groups/8f0ce67f-80be-4441-8e4c-a79ccea307e9' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
  ...
  "createdTime" : 1479990689111,
  "createdBy" : "Bob Jones",
  "lastUpdatedTime" : 1479990690111,
