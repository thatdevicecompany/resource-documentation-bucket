...
}' | http POST 'https://api.breezie.com/devices/8e1425d1-0ccd-47b9-9fea-9fec8ec1b810/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----