[source,bash]
----
$ curl 'https://api.breezie.com/devices/201360ec-cc86-4b8c-bfa4-2c0631b882bf/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
