...
}' | http POST 'https://api.breezie.com/devices/400ee1be-bdae-4b85-89e0-807ee7177e86/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----