[source,bash]
----
$ curl 'https://api.breezie.com/groups/f1d58e4a-0d5e-4bf2-9c3f-f90e0921a32a' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
