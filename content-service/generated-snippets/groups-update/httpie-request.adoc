...
$ echo '{
  ...
  "personal" : false,
  "hideOnHub" : false
}' | http PUT 'https://api.breezie.com/groups/fde88ce7-4b55-453e-8121-2e8679245eae' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----