...
$ echo '{
  ...
  "visible" : true,
  "default" : true
}' | http PUT 'https://breezie.com/groups/b7b431e4-c7e1-4c93-bf07-2bc48111616b' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----