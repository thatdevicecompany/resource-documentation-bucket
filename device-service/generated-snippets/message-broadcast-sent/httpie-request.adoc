...
}' | http POST 'https://api.breezie.com/devices/2894afa2-c348-4e20-a13c-7067100aa774/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----