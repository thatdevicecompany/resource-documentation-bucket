...
}' | http POST 'https://api.breezie.com/devices/958715f9-5932-456b-a83b-fc04582be928/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----