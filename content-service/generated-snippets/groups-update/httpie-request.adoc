...
$ echo '{
  ...
  "personal" : false,
  "hideOnHub" : false
}' | http PUT 'https://api.breezie.com/groups/85ea8704-9751-4d0f-a74a-5aaf3b08d177' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----