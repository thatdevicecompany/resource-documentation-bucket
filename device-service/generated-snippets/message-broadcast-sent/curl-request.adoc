[source,bash]
----
$ curl 'https://api.breezie.com/devices/1c218569-16ed-4d72-899d-1ee33f77b390/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
