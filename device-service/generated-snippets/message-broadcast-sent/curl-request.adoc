[source,bash]
----
$ curl 'https://api.breezie.com/devices/8fc3a28b-a9e2-4f61-beb6-3a49ad80c6ef/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
