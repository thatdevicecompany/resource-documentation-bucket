[source,bash]
----
$ curl 'https://api.breezie.com/devices/508d3b16-9c3d-46ae-8a37-8f682b56b9c8/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
