...
}' | http POST 'https://api.breezie.com/devices/b78a6d49-db1c-4fb2-87ed-b9d0819e76a1/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----