...
}' | http POST 'https://api.breezie.com/devices/a9296718-b6d2-45d8-9d51-07888603928f/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----