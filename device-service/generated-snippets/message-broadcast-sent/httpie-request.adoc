...
}' | http POST 'https://api.breezie.com/devices/774b04a6-c83c-4d69-8566-b8062a47e4c3/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----