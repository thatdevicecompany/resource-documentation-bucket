...
}' | http POST 'https://api.breezie.com/devices/6a8eccb1-879f-41f2-af49-1fc9a44e8969/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----