...
$ echo '{
  ...
  "visible" : true,
  "default" : true
}' | http PUT 'https://breezie.com/groups/c8c3ff8a-b797-4927-a364-e888922219be' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----