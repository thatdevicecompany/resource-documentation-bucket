...
}' | http POST 'https://api.breezie.com/devices/20864c50-4478-47e6-b456-979ec79a322f/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----