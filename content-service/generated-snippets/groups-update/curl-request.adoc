[source,bash]
----
$ curl 'https://breezie.com/groups/c8c3ff8a-b797-4927-a364-e888922219be' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
  ...
  "createdTime" : 1475504522416,
  "createdBy" : "Bob Jones",
  "lastUpdatedTime" : 1475504523416,
