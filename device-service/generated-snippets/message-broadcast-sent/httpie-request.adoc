...
}' | http POST 'https://api.breezie.com/devices/1b62ca58-6133-44e7-b1de-7863832ceaa9/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----