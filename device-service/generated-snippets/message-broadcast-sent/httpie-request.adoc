...
}' | http POST 'https://api.breezie.com/devices/be3bf18d-16fa-4274-8754-88bc2ba8f6c7/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----