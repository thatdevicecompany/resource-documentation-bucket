...
}' | http POST 'https://api.breezie.com/devices/f81a7148-9e09-48a1-825e-849305cc95ab/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----