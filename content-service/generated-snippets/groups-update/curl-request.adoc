[source,bash]
----
$ curl 'https://breezie.com/groups/e9489b77-a8a5-4388-b0be-866991815552' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
  ...
  "createdTime" : 1480350685175,
  "createdBy" : "Bob Jones",
  "lastUpdatedTime" : 1480350686175,
