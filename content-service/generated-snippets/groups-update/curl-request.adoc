[source,bash]
----
$ curl 'https://api.breezie.com/groups/2552a6ea-e328-4f9e-b0c6-b97f9ac7c093' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
