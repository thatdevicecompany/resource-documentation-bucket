[source,bash]
----
$ curl 'https://breezie.com/groups/df4b073f-f8ee-4a15-b9c2-c3ce9bd51bec' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
