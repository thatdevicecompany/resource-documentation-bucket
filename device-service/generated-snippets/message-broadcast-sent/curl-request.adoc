[source,bash]
----
$ curl 'https://api.breezie.com/devices/bfbfef2c-ceae-4991-a591-d767c2d48df4/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
