[source,bash]
----
$ curl 'https://api.breezie.com/groups/460deaa5-cad3-480c-b6ed-6d05161c82b4' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
