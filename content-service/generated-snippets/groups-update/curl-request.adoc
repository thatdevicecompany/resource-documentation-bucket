[source,bash]
----
$ curl 'https://api.breezie.com/groups/5c429a57-e022-46f9-924b-c1fe928c34bf' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
