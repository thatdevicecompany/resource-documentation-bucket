...
}' | http POST 'https://api.breezie.com/devices/0e82ba49-3a2b-4217-80a5-2720c9187b21/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----