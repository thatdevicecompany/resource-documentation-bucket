...
$ echo '{
  ...
  "visible" : true,
  "default" : true
}' | http PUT 'https://breezie.com/groups/1acddc29-d860-4fdd-8c34-0d83561ae63f' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----