...
}' | http POST 'https://api.breezie.com/devices/a3a53734-7fc1-4a67-987b-5ef7d9f39be3/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----