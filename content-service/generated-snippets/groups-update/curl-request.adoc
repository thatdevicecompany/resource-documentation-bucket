[source,bash]
----
$ curl 'https://breezie.com/groups/3bb2323c-d1b3-4fd7-a6af-f2bc898a33ca' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
