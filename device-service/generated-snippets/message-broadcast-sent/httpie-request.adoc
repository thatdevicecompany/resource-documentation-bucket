...
}' | http POST 'https://api.breezie.com/devices/ee4d9799-2874-472c-834a-b9ef484e8630/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----