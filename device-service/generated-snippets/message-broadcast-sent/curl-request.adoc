[source,bash]
----
$ curl 'https://api.breezie.com/devices/ea10b9c3-5707-499a-8912-add9d9bd1a70/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
