...
}' | http POST 'https://api.breezie.com/devices/007ff998-5a75-47e9-8fb5-8f9bfbeca145/messages' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json;charset=UTF-8'
----