[source,bash]
----
$ curl 'https://api.breezie.com/devices/906905c7-b44a-4ede-ad44-7c2e0891760e/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
