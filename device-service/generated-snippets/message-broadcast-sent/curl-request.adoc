[source,bash]
----
$ curl 'https://api.breezie.com/devices/d7e10963-a5d2-4d5e-a46d-1c0032848b21/messages' -i -X POST -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json;charset=UTF-8' -d '{
