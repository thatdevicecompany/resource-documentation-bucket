[source,bash]
----
$ curl 'https://api.breezie.com/groups/6631a2a8-e514-4767-a42e-068d8065bb1c' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
