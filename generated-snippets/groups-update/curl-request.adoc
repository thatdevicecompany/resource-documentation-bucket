[source,bash]
----
$ curl 'https://breezie.com/groups/7556713d-e112-4ce9-9bf2-925311316bbe' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Gardening",
