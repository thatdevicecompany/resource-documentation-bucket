[source,bash]
----
$ curl 'https://api.breezie.com/groups/b6b76559-f307-4958-9521-758cdf4c8a0c' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
