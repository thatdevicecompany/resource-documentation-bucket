...
$ echo '{
  ...
  "visible" : true,
  "default" : true
}' | http PUT 'https://breezie.com/groups/08880034-b59a-41a3-bffd-c649cfbd2b77' 'Authorization: Bearer:0b79bab50daca910b000d4f1a2b675d604257e42' 'Content-Type:application/json'
----