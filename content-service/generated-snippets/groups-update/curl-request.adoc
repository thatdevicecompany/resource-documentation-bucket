[source,bash]
----
$ curl 'https://api.breezie.com/groups/25d7ef4f-7820-4ec9-b882-f12c2284ba65' -i -X PUT -H 'Authorization: Bearer: 0b79bab50daca910b000d4f1a2b675d604257e42' -H 'Content-Type: application/json' -d '{
  "name" : "Garden",
